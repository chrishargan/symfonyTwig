...
class __TwigTemplate_9a82b5189dabdf03e145bd0cfb661a01a839580ba31ec854eb28df0bae808a7d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <p>Europe ";
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, (isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 6, $this->source); })()), "medium", "medium", "d/y/M"), "html", null, true);
        echo "</p>
    <p> America ";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, (isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 7, $this->source); })()), "medium", "medium", "M/d/y"), "html", null, true);
        echo "</p>
    <p>China & Japan ";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, (isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 8, $this->source); })()), "medium", "medium", "y/M/d"), "html", null, true);
        echo "</p>
";
    ...
    <div class=\"example-wrapper\">
        ...
        <h2>Hey I'm ";
        // line 29
        echo twig_escape_filter($this->env, twig_title_string_filter($this->env, (isset($context["name"]) || array_key_exists("name", $context) ? $context["name"] : (function () { throw new RuntimeError('Variable "name" does not exist.', 29, $this->source); })())), "html", null, true);
        echo " ,</h2>
...
";
    ...
    {
        return array (  143 => 29,  124 => 12,  114 => 11,  102 => 8,  98 => 7,  93 => 6,  89 => 5,  79 => 4,  60 => 3,  37 => 1,);
    }
...
{% block menu %}
    {{ parent() }}         {# basically acts as a copy and paste from the contents of this named block from the base twig #}
